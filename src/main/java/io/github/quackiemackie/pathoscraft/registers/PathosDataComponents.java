...
public class PathosDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<WorkerNodeList>> WORKER_NODE_DATA = register("worker_node_data", builder -> builder.persistent(WorkerNodeList.CODEC));
