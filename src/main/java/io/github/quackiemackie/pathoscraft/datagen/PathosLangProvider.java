...
public class PathosLangProvider extends LanguageProvider {
    ...
    private void addWorkerTranslation() {
        ...
        this.add("item.pathoscraft.skilled_worker", "Skilled Worker");
        this.add("item.pathoscraft.professional_worker", "Professional Worker");
        this.add("item.pathoscraft.artisan_worker", "Artisan Worker");
    }
    ...
    private void addStaticTranslations() {
        ...
        // Entities
        this.add("entity.pathoscraft.spider_mount", "Spider Mount");
        this.add("entity.pathoscraft.mushroom", "Mushroom");
        this.add("entity.pathoscraft.player_ghost", "Astral Form");
